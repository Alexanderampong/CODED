...
e= 'The bending moment at x=0 is '
f= 'The shear force at x=0 is '
...
a= 'The bending moment at x=12 is '
b= 'The shear force at x=12 is '
...
# (b)
#When M = 0, the equation is x**2 - L*x + L**2/6 = 0
L= 12
#from the equation 
a = 1
b = -L
...
a = '(d) The bending moment at each step in the array is' 
print(a + str(M))
...
discriminant = b**2 - 4*a*c
root_1c = (-b + np.sqrt(discriminant))/2*a
root_2c = (-b - np.sqrt(discriminant))/2*a
...
r_e1 = ((root_1b - root_1c)/root_1b*100) 
r_e2 = ((root_2c - root_2b)/root_2c*100)
...
# The link for the code on github
#
